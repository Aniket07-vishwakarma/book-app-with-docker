...
module.exports.addFavorite = async (req, res) => {
    try {
        // let { publishers, number_of_pages, covers, key, authors, ocaid, contributions, languages, source_records, title, identifiers, isbn_13, local_id, publish_date, works, type, first_sentence, latest_revision, revision, created, last_modified } = req.body;

        let { title, key, author, image_name } = req.body;
        ...
        if (favoriteBook.length > 0) {
            ...
            // }
            let favoriteBookObj = { title, key, author, image_name }
